module.exports = {
  ...
  subtitle(data, presets) {
    return `Checar ${data.branches.length} possibilidades`;
  },
...
<tab-system>
  <tab label="Informação" icon="align left">
    <span class="dbminputlabel">Informação</span>
    <textarea class="round" id="storage" rows="16" placeholder="Informação..."></textarea>
  </tab>

  <tab label="Comparações e ações" icon="list alternate">
    <dialog-list id="branches" fields='["comparison", "value", "value2", "actions"]' dialogResizable dialogTitle="Check Variable Info" dialogWidth="600" dialogHeight="400" listLabel="Comparações e ações" listStyle="height: calc(100vh - 250px);" itemName="Condition" itemHeight="28px;" itemTextFunction="glob.formatItem(data)" itemStyle="line-height: 28px;">
